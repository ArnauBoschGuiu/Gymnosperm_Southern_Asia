...
# ==============================================================================
{
  lgm_land = raster("/Users/Desktop/AisanConifer_dataset/high_longlat_lgm_NA.tif") %>%
    crop(., ext) %>%
    resample(., env)

  for(d in c("cc","mr","me")){
    print(d)
    eval(parse(text=paste0("bio_lgm_",d," = list.files('/Users/Desktop/AisanConifer_dataset/WorldClim1.4/",d,"lgm',
...
# ==============================================================================
{
  for(d in c("cc","mr","me")){
    print(d)
    eval(parse(text=paste0("bio_mh_",d," = list.files('/Users/Desktop/AisanConifer_dataset/WorldClim1.4/",d,"midbi_2-5m',
  pattern = '.tif', full.names = TRUE)")))
...
for(d in scenario){
  for(r in rcp){
    for(t in times){
      ...
      print(r)
      print(t)
      eval(parse(text=paste0("bio_",d,"_",r,"_",t," = list.files('/Users/Desktop/Gymnosperm_wc2-5_future_cmip6/',
...
# out put of species under 20 locations 
